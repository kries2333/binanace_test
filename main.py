...
"""
闪闪的
id = '574328f20962b37a14cf8a25b1b3f2710ba84d915203b3d912a8120bba2c29ce'
secret = 'SEC6a978202c11e2d35b1143473cc435b4505009ac6b1a6260a11edeaff60ff4530'
robot_id_secret = [robot_id, secret]
"""

"""
kries
robot_id = 03f3c6bd782651e92f7d53efa435b3716264e2d3d7cd409be5059a2147f973fd
...
symbol_config = {
    'ETHUSDT': {'leverage': 2,  # 控制实际交易的杠杆倍数，在实际交易中可以自己修改。此处杠杆数，必须小于页面上的最大杠杆数限制
                 'strategy_name': 'real_signal_adp2boll_v2',  # 使用的策略的名称
                 'para': [905],  # 策略参数
...
def main():
    ...
    while True:
        ...
        # 发送钉钉
        dingding_report_every_loop(symbol_info, symbol_signal, order_list, run_time, robot_id_secret)
...
if __name__ == '__main__':
    while True:
        try:
            ...
            content = '系统出错，10s之后重新运行，出错原因：' + str(e)
            print(content)
